...
export default function ConversationModeCard() {
  ...
  return (
    ...
    >
      ...
      <div className="text-lg font-medium text-gray-900 dark:text-gray-100">Conversation Mode</div>
      <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Real-time communication between different users</p>
    </article>
  );
}
