      ...
      recognition.onresult = (event: any) => {
        try {
          ...
          if (command.includes("back") || command.includes("go back")) {
            ...
            speakMessage("Send Feedback page. Fill out the form and say submit to submit, or say back to go back.");
          } else {
      ...
      <main className="min-h-screen bg-white dark:bg-gray-900 pt-12 flex items-start justify-center">
        <div className="w-full max-w-2xl mx-auto px-6 text-left">
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-300 dark:border-green-700 rounded-sm p-6 text-center">
            ...
            <h2 className="text-2xl font-bold text-green-800 dark:text-green-300 mb-2">Feedback Sent</h2>
    ...
    <main className="min-h-screen bg-white dark:bg-gray-900 pt-12 flex items-start justify-center">
      <div className="w-full max-w-2xl mx-auto px-6 text-left">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="feedbackType" className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={8}
              placeholder="Share your thoughts, suggestions, or ideas about M-Lingua..."
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Provide your email if you'd like us to respond to your feedback.
            </p>
          </div>
