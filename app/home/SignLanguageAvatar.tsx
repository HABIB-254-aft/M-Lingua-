...
export default function SignLanguageAvatar({ text, speed = 1, containerId = "sign-avatar" }: SignLanguageAvatarProps) {
  ...
  const getSignGesture = (word: string) => {
    ...
    if (signMapRef.current) {
      ...
      may_month: { type: "may", color: "#2196F3", emoji: "📆" },
      ...
      close_verb: { type: "close", color: "#F44336", emoji: "🚪" },
      ...
      text_verb: { type: "text", color: "#2196F3", emoji: "💬" },
      ...
      clean_verb: { type: "clean", color: "#00BCD4", emoji: "🧹" },
      wash: { type: "wash", color: "#00BCD4", emoji: "🧼" },
      dry_verb: { type: "dry", color: "#FF9800" },
      ...
      light_noun: { type: "light", color: "#FFC107", emoji: "💡" },
      ...
      orange_fruit: { type: "orange", color: "#FF9800", emoji: "🍊" },
      ...
      clean_adj: { type: "clean", color: "#00BCD4", emoji: "✨" },
      ...
      light_adj: { type: "light", color: "#00BCD4" },
      ...
      orange_color: { type: "orange", color: "#FF9800", emoji: "🟠" },
      ...
      where_prep: { type: "where", color: "#00BCD4", emoji: "📍" },
